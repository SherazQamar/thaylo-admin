...
export const DEFAULT_ELEVENLABS_VOICE_NAME = 'Bella'
...
export const FREE_TIER_FALLBACK_CATALOG = {
  freeVoices: [
    { voiceId: DEFAULT_ELEVENLABS_VOICE_ID, name: DEFAULT_ELEVENLABS_VOICE_NAME, category: 'premade', description: 'Soft, young American female', apiAvailable: true },
